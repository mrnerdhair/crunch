...
pub fn crunch_fake_main() -> CrunchOutput {
    ...
    let ch_sh_transcript_hash_reporter = HashReporter::new((|dummy_keys: Arc<DummyKeys>| move |ch_sh_transcript_hash| {
    ...
    })(Arc::clone(&dummy_keys)));

    let ch_sf_transcript_hash_reporter = HashReporter::new((|dummy_keys: Arc<DummyKeys>| move |ch_sf_transcript_hash| {
